...
class TestAPI:
    # client successfully creates an AsyncClient instance
    @pytest.mark.asyncio
    async def test_client_creates_async_client_instance(self, client):
        assert isinstance(
            client, AsyncClient
        ), "Client is not an instance of AsyncClient"

    @pytest.mark.asyncio
    async def test_create_url(self, client):
        """
        ...
        """
        print(f"Received client: {type(client)}")
    ...
    # @pytest.mark.asyncio
    # async def test_read_urls(self, client):
    #     """
    ...
    # @pytest.mark.asyncio
    # async def test_create_scrape(self, client):
    #     """
    ...
    # @pytest.mark.asyncio
    # async def test_read_all_scrapes(self, client):
    #     """
    ...
    # @pytest.mark.asyncio
    # async def test_read_scrapes_by_urlid(self, client):
    ...
    # @pytest.mark.asyncio
    # async def test_read_scrapes_by_scrapeid(self, client):
    ...
    # @pytest.mark.asyncio
    # async def test_update_scrape(self, client):
    #     # First, create a URL
    #     url_response = await client.post(
    #         "/urls/",
    #         json={
    ...
    #     ), f"Failed to create URL: {url_response.text}"
    ...
    #     assert (
    #         "id" in scrape_data
    #     ), f"Scrape response doesn't contain 'id': {scrape_data}"
